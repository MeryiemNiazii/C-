...
public:
    ...
    void addStaff(vector<Admin*>& staffList) {
        Admin* newStaff = new Admin;  // Create a new Staff object
    ...
    void addCustomer(vector<Admin*>& customerList) {
        Admin* newCustomer = new Admin;  // Create a new Customer object
    ...
    void removeCustomer(vector<Admin*>& customerList) {
        ...
        if (it != customerList.end()) {
            delete *it;  // Deallocate memory for the Customer object
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 3:
                {
                    ...
                    if (admin.authenticateCustomer(username, password, customerList)) {
                        Admin customer;  // Creating an Admin object for customer
            ...
            case 4:
                {
                    Admin* newCustomer = new Admin;  // Creating an Admin object for a new customer
                    cout << "Enter new customer username: ";
                    cin >> newCustomer->username;
                    cout << "Enter new customer password: ";
                    cin >> newCustomer->password;
